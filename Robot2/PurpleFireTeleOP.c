...
#pragma config(Motor,  port4,           LARMA,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           LARMB,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port6,           CLAW1,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           CLAW2,         tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           RARMA,         tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port9,           RARMB,         tmotorServoContinuousRotation, openLoop, reversed)
...
#define clawOPEN 3470
#define clawCLOSE 405
